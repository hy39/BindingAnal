function [tr] = annotate_tree(file, netcharge)
...
%%Need to find the netcharge given internal ID. Jul 2, 2013
        ...
        cur_inter_str = '';
        cur_inter_str = [num2str(cur_inter_node) '[&annotation="",Netcharge.set="' trait_charge '"]'];
...
% Search the netcharge for cur_tip.
      ...
      cur_tip_str = '';
      % add new annotation
      cur_tip_str = [num2str(nm(end,1:pos_e)) '[&annotation="",Netcharge.set="' trait_charge '"]'];
