...
%xlim([0 13]);
if (ngs_no == 8)
    line([1998.2 1998.2],[12 22], 'Color', [.8 .8 .8]);
end
if (ngs_no == 9)
    line([1995.2 1995.2],[12 22], 'Color', [.8 .8 .8]);
end
if (ngs_no == 10)
    line([2000.18 2000.18],[12 22], 'Color', [.8 .8 .8]);
    line([2003.25 2003.25],[12 22], 'Color', [.8 .8 .8]);
    line([2004.05 2004.05],[12 22], 'Color', [.8 .8 .8]);
end
if (ngs_no == 11)
    line([2000.05 2000.05],[12 22], 'Color', [.8 .8 .8]);
    line([2004.1 2004.1],[12 22], 'Color', [.8 .8 .8]);
end
